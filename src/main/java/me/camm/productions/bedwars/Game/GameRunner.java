...
import me.camm.productions.bedwars.Game.Events.ActionEvent;
import me.camm.productions.bedwars.Game.Events.GameEndAction;
...
import static me.camm.productions.bedwars.Game.Scoreboard.ScoreBoardHeader.TIME;
...
public class GameRunner
{
    ...
    this.runnableFraction = EventTime.RUNNABLE_PERIOD.getTime()/ EventTime.TICKS.getTime();
    ...
    this.totalGameTime = EventTime.TOTAL_GAME_TIME.getTime();
    ...
    public void initListeners(){
       ...
       damageListener = new EntityActionListener(arena, this);
       explosionListener = new ExplosionHandler(plugin, arena,damageListener);
        ...
        npcManager = new EntityActionListener.LocationManager(arena,keepers,packetHandler,this);
        npcManager.runTaskTimer(plugin,0,1);
    }
    ...
    private void start()
    {
        ...
        }.runTaskTimer(plugin,0, EventTime.TICKS.getTime());  //1 second = 20 ticks. Bukkit runnables run the
                                                        //task in ticks.
    }
 ...
 */
    private synchronized String getTimeFormatted()
    {
        ...
        String adder = remainingTime% EventTime.TIME_IN_MINUTE.getTime()<10 ? "0": "";


        //Formatting the time for the player scoreboard.
        String time = (remainingTime/ EventTime.TIME_IN_MINUTE.getTime())+":"+adder+(remainingTime% EventTime.TIME_IN_MINUTE.getTime());
