package me.camm.productions.bedwars.Game.PlayerManagers;
...
public class PlayerInventoryManager
{
    ...
    public PlayerInventoryManager(List<ShopItemSet> quickBuyConfiguration, boolean isInflated, Arena arena, BattlePlayer owner)
    {
